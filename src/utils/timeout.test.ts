...
import { TimeoutError, withTimeout, withRetry, withTimeoutAndRetry } from './timeout.js';
...
describe('timeout utilities', () => {
  ...
  describe('withTimeoutAndRetry', () => {
    ...
    it('should use custom error message in timeout error', async () => {
      vi.useRealTimers();
      const fn = vi.fn().mockImplementation(
        () =>
          new Promise((resolve) => {
    ...
    it('should handle immediate rejection without timeout', async () => {
      vi.useRealTimers();
