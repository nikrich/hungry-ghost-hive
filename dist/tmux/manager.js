 ...
 */
export async function waitForTmuxSessionReady(sessionName, maxWaitMs = 15000, pollIntervalMs = 200) {
 ...
 */
export async function forceBypassMode(sessionName, _cliTool = 'claude', maxRetries = 5) {
